export const zhCN = {
  ...
  infrastructure: {
    title: '系统管理',
    subtitle: '集中记录服务器以及域名到内网端口的部署关系',
    serverCount: '服务器',
    serviceCount: '部署服务',
    activeServiceCount: '运行中服务',
    servers: '服务器清单',
    services: '服务与域名映射',
    addServer: '添加服务器',
    editServer: '编辑服务器',
    ...
    editService: '编辑服务',
    serverName: '服务器名称',
    serverNamePlaceholder: '如：香港轻量云 01',
    host: '公网 IP / 主机名',
    hostPlaceholder: '如：1.2.3.4',
    provider: '服务商',
    providerPlaceholder: '如：阿里云、腾讯云',
    region: '地区',
    regionPlaceholder: '如：香港、新加坡',
    operatingSystem: '操作系统',
    operatingSystemPlaceholder: '如：Debian 12',
    sshPort: 'SSH 端口',
    username: '登录用户',
    usernamePlaceholder: '如：root',
    serviceName: '服务名称',
    serviceNamePlaceholder: '如：SubLedger',
    domain: '域名',
    domainPlaceholder: '如：ledger.example.com',
    server: '所在服务器',
    protocol: '访问协议',
    internalHost: '内网地址',
    internalHostPlaceholder: '如：127.0.0.1 或容器名',
    internalPort: '内网端口',
    containerName: '容器 / 项目名',
    containerNamePlaceholder: '可选，如：subledger',
    notes: '备注',
    active: '启用',
    inactive: '停用',
    serviceUnit: '{count} 个服务',
    unassigned: '未选择服务器',
    searchPlaceholder: '搜索服务、域名、服务器或端口',
    filterAllServers: '全部服务器',
    mapping: '内网映射',
    copyMapping: '复制映射',
    copied: '已复制到剪贴板',
    openDomain: '访问域名',
    noServerTip: '请先添加一台服务器，再记录部署服务',
    requiredTip: '请填写所有必填项',
    deleteServerConfirm: '确定删除服务器“{name}”吗？',

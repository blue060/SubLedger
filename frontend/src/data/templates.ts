...
export const TEMPLATES: SubscriptionTemplate[] = [
  ...
  { name: 'GitHub Copilot', amount: 10.00, currency: 'USD', billing_cycle: 'monthly', category_name: 'AI工具', url: 'https://github.com' },
  { name: 'Microsoft 365', amount: 6.99, currency: 'USD', billing_cycle: 'monthly', category_name: '其他', url: 'https://microsoft.com' },
  ...
  { name: 'Notion Plus', amount: 10.00, currency: 'USD', billing_cycle: 'monthly', category_name: '其他', url: 'https://notion.so' },
  { name: '1Password', amount: 2.99, currency: 'USD', billing_cycle: 'monthly', category_name: '其他', url: 'https://1password.com' },
  ...
  { name: 'WPS会员', amount: 18.00, currency: 'CNY', billing_cycle: 'monthly', category_name: '其他', url: 'https://wps.cn' },
  { name: 'Discord Nitro', amount: 9.99, currency: 'USD', billing_cycle: 'monthly', category_name: '其他', url: 'https://discord.com' },
]
